...
const ProductPage: React.FC<ProductPageProps> = ({ product }) => {
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-purple-900 py-12 px-4 sm:px-6 lg:px-8 transition-opacity duration-500" style={{ opacity: isLoading ? '0' : '1' }}>
